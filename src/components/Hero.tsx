...
export default function Hero() {
  return (
    <section id="home" className="relative isolate flex min-h-dvh flex-col justify-center px-4 pt-20 sm:px-8 lg:px-16">
      {/* Background Ambience */}
      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            {/* Status Indicator */}
            <div className="mb-6 flex items-center gap-3 rounded-full border border-white/5 bg-white/5 px-4 py-1.5 backdrop-blur-sm">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
              </span>
              <span className="text-xs font-medium tracking-wide text-white/80 uppercase">System Online • Available for work</span>
            </div>
            ...
            <p className="mt-8 max-w-xl text-lg leading-relaxed text-white drop-shadow-md">
              Architecting digital experiences at the intersection of design and artificial intelligence. 
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <Button variant="ghost" size="lg" asChild>
                <a href="#about">Initialize Contact</a>
              </Button>
            </div>
          </motion.div>
          ...
          <div className="hidden lg:block relative h-full min-h-[400px]">
             ...
             >
                <div className="flex flex-col gap-2">
                   ...
                   <div className="text-[10px] text-purple-300 font-mono">COORDINATES: 51.5074° N, 0.1278° W</div>
                </div>
             </motion.div>
          </div>
      ...
      >
        ...
        <span className="text-[10px] uppercase tracking-widest text-white/30 vertical-writing-rl rotate-180">Scroll to Explore</span>
      </motion.div>
    </section>
  )
}
